 ...
 *
 *
 * @generated SignedSource<<e1892ba80fa927e0108fd172cd1fc6e2>>
 */
...
final class FooInterface extends \Slack\GraphQL\Types\InterfaceType {

  const NAME = 'FooInterface';
  const type THackType = \Foo\FooInterface;
  ...
  public async function resolveAsync(
    ...
    if ($value is \Foo\FooObject) {
      return await FooObject::nonNullable()->resolveAsync($value, $parent_nodes, $context);
    }
    invariant_violation(
