...
final class FieldsOnCorrectTypeRuleTest extends BaseValidationTest {
    ...
    public static function getTestCases(): this::TTestCases {
        return dict[
            ...
            'inline fragment on interface' => tuple(
                'query {
                    viewer {
                        id
                        ... on Human {
            ...
            'named fragment on interface' => tuple(
                '
                query {
                    viewer {
                        id
            ...
            'invalid field in fragment' => tuple(
                '
                query {
                    viewer {
                        id
                ...
                vec[
                    shape(
                        'message' => 'Cannot query field "favorite_color" on type "User".',
                        'location' => shape('line' => 9, 'column' => 21),
                    ),
                ],
            ),
            'valid inline fragment in fragment' => tuple(
                '
                query {
                    viewer {
                        id
